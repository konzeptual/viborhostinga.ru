...
Radiant::Initializer.run do |config|
  ...
  config.action_controller.session = {
    :session_key => '_viborhostinga.ru_session',
    :secret      => '4fbb3c20172c85a4533fbf93e032c4f2c765e665'
  }
  ...
  config.after_initialize do
    ...
    Radiant::Config['tags.results_page_url'] = '/poisk/po-metke'
    Radiant::Config['tags.complex_strings'] = true
    Radiant::Config['tags.search_page_title'] = 'Статьи с меткой'
